     ...
     <>
        ...
        <div className=' md:w-[1500px] w-[400px] grid grid-cols-12 mx-auto bg-transparent gap-x-6 gap-y-6 px-4'>
            <div className='col-span-12 md:col-span-5 flex flex-col items-start justify-center mt-[70px] mb-[70px]'>
                ...
                <span className='text-md md:text-xl text-black/90 mt-[70px] font-bold'>Registrate y se el primero en descubrir 
            ...
            <li className='text-sm md:text-lg list-none mb-[24px] font-semibold py-2 uppercase' onClick={handleHelpListToggle}>
              Ayuda 
              {isMobile ? <img src={downArrowIcon} alt="Down arrow icon" className='size-4 inline-block cursor-pointer cursor-pointer'/> : ''}
            </li>
            ...
            <div className='col-span-4 md:col-span-3 justify-start items-start w-full md:mt-[70px] mb-[70px]'>
