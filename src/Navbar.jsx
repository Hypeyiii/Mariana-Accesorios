...
export function Header(){
    ...
    return(
      <>
        <Navbar className='fixed z-40 top-0  shadow-md flex flex-col sm:flex-row px-8 backdrop-blur-sm bg-white/70 md:bg-white/60 transition-all duration-1000 w-full mx-auto'>
