...
function InfoProductModal({
  ...
  return (
    <>
      ...
      ></div>
      <div
        className="scale-in-center fixed mx-auto inset-0 top-0 w-[95%] md:w-9/12 h-[90%] md:h-[80%] overflow-y-auto py-[50px] shadow-2xl shadow-black
                 bg-white m-auto items-center justify-center grid grid-cols-12 gap-x-2 gap-y-2 px-2 z-50"
      >
        <div className="col-span-12 absolute top-0 flex items-center justify-center w-full mt-2">
          <h1 className="text-lg md:text-2xl font-bold text-black/80">
            Detalles del Producto
          </h1>
        </div>
        <MdClose
          className="absolute top-2 right-2 size-6 md:size-10 text-3xl cursor-pointer text-pink-300 hover:text-red-600 hover:bg-gray-200 z-50"
          onClick={onClose}
        />
        <div className=" col-span-12 md:col-span-2 flex flex-row md:flex-col gap-2 md:gap-4 items-center justify-center md:h-full">
          <div
            className="flex flex-col gap-2 items-center justify-center p-2  md:border bg-[#f6f6f6] size-2/4 
          ...
          >
            ...
            <p className="text-[8px] border-b-[1px] md:border-b-2 border-b-pink-300 text-center">
              Vista frontal
            </p>
          </div>
          <div
            className="flex flex-col gap-2 items-center justify-center p-2 size-2/4  md:border bg-[#f6f6f6]
        ...
        <div
          className=" col-span-12 md:col-span-6 flex items-center justify-center md:bg-[#f6f6f6] [&>img]:hover:scale-100
                        md:border md:border-black/10 h-full flex-col"
        >
          <img
            src={selectedImage}
            alt={`${name} Image`}
            className="transition md:scale-90 cursor-zoom-in"
          />
        </div>
        <div className="h-full col-span-12 md:col-span-4 flex flex-col gap-y-4 items-center justify-center px-4">
          <p className="text-black/80 text-sm md:text-base border-b-[1px] md:border-b-2 border-b-pink-300">
            {category}
          </p>
          <h1 className="text-black font-semibold text-base md:text-2xl">
            {name}
          </h1>
          <h2 className="text-black/90 font-bold text-sm md:text-base">
            ${price}.00 <span className="text-xs">MX</span>
          </h2>
          ...
          <p className="text-xs md:text-sm font-bold text-black/80">
          ...
          <div className="flex flex-row gap-x-2 items-center justify-center mt-5">
            <button
              className="py-2 px-2 md:px-6 text-white bg-black rounded-sm font-bold text-[10px] md:text-xs hover:bg-pink-300/60
          ...
          <button
            className="py-2 px-6 text-black bg-pink-300/60 hover:text-white hover:bg-black text-[10px] md:text-xs transition
