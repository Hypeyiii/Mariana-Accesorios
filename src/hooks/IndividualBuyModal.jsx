...
function IndividualBuyModal({
  ...
  return (
    <>
      <div
        className="fixed inset-0 w-screen h-screen bg-black/50 md:bg-black/80 text-white z-40"
        onClick={onCloseOnce}
      ></div>
      <div
        className="scale-in-center fixed top-0 right-0 left-0 bottom-0 m-auto items-center justify-start bg-white w-[95%] md:w-[27%] 
      ...
      >
        <div
          className="absolute top-0 left-0 bg-white/50 p-4 z-50 cursor-pointer"
          onClick={back}
        >
        ...
        <div className="absolute top-0 flex flex-row gap-x-2 items-center justify-center right-0 left-0 mt-4">
          <p className="text-black/70 font-semibold text-2xl border-b-2 border-b-pink-300">
            Comprar ahora
          </p>
        </div>
        <div className="relative [&>img]:hover:scale-100 w-full col-span-6 flex items-center justify-center transition mt-24">
          <img
            src={img}
            alt={img + "Image"}
            className="transition scale-90 size-[175px] md:size-[300px]"
          />
          {isHover ? (
            <>
              <div
                className="blur-in absolute right-0 p-1 rounded-full border-[0.5px] border-black/50
                        cursor-pointer hover:shadow-lg shadow-black"
              >
                <GoArrowRight className="size-8 text-black/50" />
              </div>
              <div
                className="blur-in absolute left-0 p-1 rounded-full border-[0.5px] border-black/50
                        cursor-pointer hover:shadow-lg shadow-black"
              >
            ...
            <>
              <div
                className="blur-out absolute right-0 p-1 rounded-full border-[0.5px] border-black/50
                        cursor-pointer hover:shadow-lg shadow-black"
              >
                <GoArrowRight className="size-8 text-black/50" />
              </div>
              <div
                className="blur-out absolute left-0 p-1 rounded-full border-[0.5px] border-black/50
                        cursor-pointer hover:shadow-lg shadow-black"
              >
                <GoArrowLeft className="size-8 text-black/50" />
              </div>
