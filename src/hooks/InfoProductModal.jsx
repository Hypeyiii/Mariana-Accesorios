        ...
        <div className="fixed top-0 right-0 left-0 bottom-0 bg-black/50" onClick={onClose}></div>
            <div className="scale-in-center fixed mx-auto inset-0 top-16 w-[350px] md:w-9/12 h-[550px] overflow-y-auto md:h-fit py-[50px] shadow-2xl shadow-black
                ...
                <MdClose className="absolute top-2 right-2 size-6 md:size-10 text-3xl cursor-pointer hover:text-red-600 hover:bg-gray-200 z-50" 
                    onClick={onClose}/>
                    <div className='mt-5 col-span-12 md:col-span-2 flex flex-row md:flex-col gap-2 md:gap-4 items-center justify-center md:h-full'>
                        <div className='flex flex-col gap-2 items-center justify-center p-2 size-1/2 md:border bg-[#f6f6f6]
                        ...
                        <div className='flex flex-col gap-2 items-center justify-center p-2 size-1/2 md:border bg-[#f6f6f6]
                            md:border-black/5 hover:border-black/60 hover:shadow-md md:shadow-xl hover:shadow-black/60 md:hover:scale-105 transition'>
                            <img src={img} alt="Image" className='size-3/4'
                            onClick={()=>setSelectedImage(img)}/>
                        ...
                        <div className='flex flex-col gap-2 items-center justify-center p-2 size-1/2 md:border bg-[#f6f6f6]
                            md:border-black/5 hover:border-black/60 hover:shadow-md md:shadow-xl hover:shadow-black/60 md:hover:scale-105 transition'>
                            <img src={img} alt="Image" className='size-3/4' onClick={()=>setSelectedImage(img)}/>
                            <p className='text-[8px] border-b-[1px] md:border-b-2 border-b-pink-300 text-center'>Vista lateral</p>
                        </div>
                        <div className='flex flex-col gap-2 items-center justify-center p-2 size-1/2 md:border bg-[#f6f6f6] 
                            md:border-black/5 hover:border-black/60 hover:shadow-md md:shadow-xl hover:shadow-black/60 md:hover:scale-105 transition'>
                    ...
                    <div className='mt-5 col-span-12 md:col-span-6 flex items-center justify-center md:bg-[#f6f6f6] [&>img]:hover:scale-100
                    md:border md:border-black/10 h-full'>
                        <img src={selectedImage} alt={`${name} Image`} className='size-[150px] md:size-3/4 transition md:scale-90 cursor-zoom-in'/>
                    </div>
                    <div className='mt-5 col-span-12 md:col-span-4 flex flex-col gap-y-4 items-center justify-center px-4'>
